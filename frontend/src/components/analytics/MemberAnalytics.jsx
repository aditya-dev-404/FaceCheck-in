      ...
      {!data ? (
        ...
        <>
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-5">
            ...
            <div className="clay-card py-4 text-center">
              <div className="text-xl font-medium text-text">{Math.round(data.lateRate * 100)}%</div>
              <div className="text-xs text-text-muted mt-1">Late rate</div>
            </div>
            <div className="clay-card py-4 text-center">
              <div className="text-xl font-medium text-text">{data.avgLateMinutes}m</div>
              <div className="text-xs text-text-muted mt-1">Avg lateness</div>
            </div>
          </div>
